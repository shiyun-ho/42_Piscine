...
/*   Updated: 2024/03/13 17:49:20 by hshi-yun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <stdio.h>
...
int main(void)
{
    ...
    printf("5^2 = %d\n", ft_iterative_power(5, 2));  // Expected: 25
    ...
    // Base equal to zero
    printf("\nBase equal to zero:\n");
    printf("0^3 = %d\n", ft_iterative_power(0, 3));  // Expected: 0
    printf("0^0 = %d\n", ft_iterative_power(0, 0));  // Expected: 1
    
    // Base equal to one
    printf("\nBase equal to one:\n");
    printf("1^3 = %d\n", ft_iterative_power(1, 3));  // Expected: 1
    printf("1^0 = %d\n", ft_iterative_power(1, 0));  // Expected: 1
    ...
    // Large exponents
    printf("\nLarge exponents:\n");
    printf("2^10 = %d\n", ft_iterative_power(2, 10));  // Expected: 1024
    printf("10^5 = %d\n", ft_iterative_power(10, 5));  // Expected: 100000
